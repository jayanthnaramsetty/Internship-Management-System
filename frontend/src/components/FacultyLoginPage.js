...
const url = "http://localhost:8080/internManagement/login";
class FacultyLoginPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      username: "",
...
export default withRouter(FacultyLoginPage);
